...
def ivr():
    ...
    if request.method == 'POST':
        ...
        if digit == '1':
            ...
            return get_forward( forward_number = call_number, message = message) 
            ...
            return get_forward( forward_number = call_number, message = 'Calling Help line.')
...
def get_forward(extension = False, forward_number = False, message = 'Forwarding Now'):
    r = plivoxml.ResponseElement()
